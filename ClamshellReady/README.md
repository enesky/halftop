...
- **Go to Sleep** releases the app's temporary assertion and then puts the Mac to sleep with a one-shot `pmset sleepnow` command. It does not change **Ignore Lid Close (Disable sleep)**.
